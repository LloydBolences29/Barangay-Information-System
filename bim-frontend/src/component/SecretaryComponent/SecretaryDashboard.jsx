          ...
          <div className="dashboard-wrapper">
            ...
            <div className="pie-and-count-up-chart-wrapper">
              <div className="pie-chart-container">
                <GenderPieChart maleCount={allStats.total_male_residents} femaleCount={allStats.total_female_residents} />
              </div>
              <div className="count-up-container">
                <div className="total-household-count-up">
                  <CountUpComponent title={"Total Number of Households"} count={allStats.total_households}/>
                </div>
                <div className="total-resident-count-up">
                  <CountUpComponent title={"Total Number of Active Residents"} count={allStats.total_active_residents}/>
                </div>
              </div>
            </div>
          </div>
